...
export default function VillagePotentialExplorer({ potentials }: { potentials: VillagePotential[] }) {
  ...
  return <div className="potential-explorer">
    ...
    <div className="potential-panel">
      <div className="potential-panel-head"><span><Icon size={22} /></span><div><small>Potensi Desa Margomulyo</small><h3>{activeSection}</h3></div><strong>Data {items[0].source_year}</strong></div>
